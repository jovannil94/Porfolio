    ...
    return (
        <div className="tripHikersContainer">
            ...
            <div className="tripHikersContext">
                ...
                <div className="tripHikersDetails">
                    <Typography variant="h4" paragraph={true}>
                        Check It Out
                    </Typography>
                ...
                <div className="tripHikersRight">
                    ...
                    <Typography variant="body1" align="left" paragraph={true}>
                        Triphikers is a 10-week Capstone project with the aim of allowing users to post, share, and join others trips from around the world. We hope to connect and encourage people to travel, share photos, and make new friends. Hosted live, both front and backend, Triphikers uses several complex components to achieve the functionality and UI/UX we deemed best for our users. 
                    </Typography>
                    <Typography variant="body1" align="left" paragraph={true}>
