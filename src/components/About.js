            ...
            <div className="aboutContext">
                ...
                <div className="aboutRight">
                    ...
                    <div className="aboutConnect">
                        ...
                        <Button onClick={()=>window.open('https://www.linkedin.com/in/jovanniluna')} variant="contained" color="primary" style={{maxWidth: '100%', maxHeight: '10%', minWidth: '50%', minHeight: '5%'}}> LinkedIn </Button>
                        <Button onClick={()=>window.open('https://github.com/jovannil94')} variant="contained" color="primary" style={{maxWidth: '100%', maxHeight: '10%', minWidth: '50%', minHeight: '5%'}}> GitHub </Button>
                        <Button onClick={()=>window.open('https://docs.google.com/document/d/1CA8DVkXFKTe8sec_udYi1kDJccfwlZFGqRcFSdXSyEY/edit?usp=sharing')} variant="contained" color="primary" style={{maxWidth: '100%', maxHeight: '10%', minWidth: '50%', minHeight: '5%'}}> Resume </Button>
                        <Button onClick={()=>window.location.href = `mailto:jovanniluna@pursuit.com`} variant="contained" color="primary" className="aboutEmail" style={{maxWidth: '100%', maxHeight: '10%', minWidth: '50%', minHeight: '5%'}}> Email Me </Button>
                    </div>
                </div>
            </div>
        </div>
