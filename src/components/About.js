            ...
            <div className="aboutContext">
                <div className="aboutLeft">
                    ...
                    <div className="aboutConnect">
                        ...
                        <Button startIcon={<LinkedInIcon/>} onClick={()=>window.open('https://www.linkedin.com/in/jovanniluna')} variant="contained" color="primary" style={{maxWidth: '400px', maxHeight: '50px', minWidth: '160px', minHeight: '30px'}}> LinkedIn </Button>
                        <Button startIcon={<GitHubIcon/>} onClick={()=>window.open('https://github.com/jovannil94')} variant="contained" color="primary" style={{maxWidth: '400px', maxHeight: '50px', minWidth: '160px', minHeight: '30px'}}> GitHub </Button>
                        <Button startIcon={<DescriptionIcon/>} onClick={()=>window.open('https://docs.google.com/document/d/1CA8DVkXFKTe8sec_udYi1kDJccfwlZFGqRcFSdXSyEY/edit?usp=sharing')} variant="contained" color="primary" style={{maxWidth: '400px', maxHeight: '50px', minWidth: '160px', minHeight: '30px'}}> Resume </Button>
                        <Button startIcon={<EmailIcon/>} onClick={()=>window.open('https://mail.google.com/mail/u/0/?view=cm&fs=1&tf=1&source=mailto&to=jovanniluna@pursuit.org;jovannil94@gmail.com')} variant="contained" color="primary" className="aboutEmail" style={{maxWidth: '400px', maxHeight: '50px', minWidth: '160px', minHeight: '30px'}}> Email Me </Button>
                    </div>
                </div>
                <div className="aboutRight">
                    <Typography variant="body1" align="left" paragraph={true}>
                         Hello there, I am <b>Jovanni Luna</b>, an aspiring software engineer from the Big Apple. For the last year, I went from having no background knowledge of coding and through some rigiourious training from a Google-funded program called <b>Pursuit</b> I can now pursue my dream of being a Full-Stack Web developer. I am always ready and eager to learn more about software development and hope for a chance to showcase my new skills.
                    </Typography>
                    <Typography variant="body1" align="left" paragraph={true}>
